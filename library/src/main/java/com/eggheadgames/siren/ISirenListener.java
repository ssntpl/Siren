...
public interface ISirenListener {
    ...
    /*
    * in the case of minor change, for update tomorrow and 7 days later
    * */
    void closeDialogAndProceed();                       //user clicked on any option, and now proceed
    void alreadyShowDialog();                           //dialog is already been visible in the case of minor patch
    void onNoUpdateDetect();                            // No update exists
}
